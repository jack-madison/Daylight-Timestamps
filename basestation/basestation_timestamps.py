...
df = pd.read_csv('./basestation/basestation_panel.csv')
...
for x in range(len(df)):
    location = LocationInfo(name = 'Japan', region = 'Japan', timezone = 'Japan', latitude = df['location_Y'][x], longitude = df['location_X'][x])
...
df.to_csv('./basestation/basestation_panel_timestamped.csv', index = False)